...
- Субаренда/саблет (аренда комнаты вместе с соседями) → SKIP (score 0).
  НО: если в тексте есть "не саблет" / "no sublet" / "לא שותפ" —
  это значит хозяин подчёркивает что квартира ПОЛНАЯ, не субаренда → оценивай нормально.
- Субаренда < 6 мес → SKIP (score 0)
